...
//drag and drop
	...
	public void driverSendKeysCapital() throws InterruptedException {
		...
		act.moveToElement(Element).pause(20).click().build().perform();
		 driver.findElement(By.name("q")).sendKeys(Keys.SHIFT,"capital");
		 
		// driver.findElement(By.name("q")).sendKeys(Keys.CTRL,"capital");
		// driver.findElements(By.name("q")).sendKeys(Keys.SHIFT,"capital");
